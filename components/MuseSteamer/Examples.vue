            ...
            <div class="container">
                ...
                <div class="example-grid">
                    ...
                    <div class="example-card">
                        ...
                        <div class="example-media">
                            <img src="https://resp.musesteamer2.com/steamer/images/Warrior-Embroidery-Irony.webp" loading="lazy" alt="Input image of a man in armor sewing">
                            <video src="https://resp.musesteamer2.com/steamer/videos/Warrior-Embroidery-Irony.mp4" loading="lazy" controls playsinline></video>
                        </div>
                        <div class="example-prompt">
                            <p>Prompt:</p>
                            "A man with his hair in a bun, wearing ancient armor, intently sews a floral fabric in an industrial workshop... The main character says: 'I, Fei Fei, am a brute, but why on earth did my big brother make me do this embroidery work?'"
                        </div>
                    </div>
                    <div class="example-card">
