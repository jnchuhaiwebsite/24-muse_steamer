                    ...
                    <div class="flex items-center gap-4 mb-2">
                        <div class="icon"><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                ...
                                <path stroke-linecap="round" stroke-linejoin="round"
                                    d="M10.5 21l5.25-11.25L21 21m-9-3h7.5M3 5.621a48.474 48.474 0 016-.371m0 0c1.12 0 2.233.038 3.334.114M9 5.25V3m3.334 2.364C13.18 7.061 14.1 7.5 15 7.5h3.75m-3.75 0V3m0 2.25l-1.5-1.5M5.25 6l-1.5-1.5m1.5 1.5V3" />
                            </svg></div>
                ...
                <article class="card">
                    <div class="flex items-center gap-4 mb-2">
                        <div class="icon"><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                stroke-width="1.5" stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round"
                                    d="M9.813 15.904L9 18.75l-.813-2.846a4.5 4.5 0 012.829-5.199l2.846-.813a4.5 4.5 0 015.199 2.829l.813 2.846M9.813 15.904L12 13.5M12 13.5l2.187 2.404M9.813 15.904L7.5 13.5m4.5 2.404l2.404-2.187M12 13.5L9.596 11.313m2.404 2.187L14.187 12M12 13.5L9.813 11.096m2.404 2.187L14.404 12m-2.404-2.813L12 9.813m0 0L9.596 7.5m2.404 2.313L14.187 7.5M12 9.813L9.813 7.204m2.404 2.61L14.404 7.204" />
                            </svg></div>
                ...
                <article class="card">
                    <div class="flex items-center gap-4 mb-2">
                        <div class="icon"><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                stroke-width="1.5" stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round"
                                    d="M15.362 5.214A8.252 8.252 0 0112 21 8.25 8.25 0 016.038 7.048 8.287 8.287 0 009 9.6a8.983 8.983 0 013.362-1.44m0 0A9.007 9.007 0 0112 3c1.227 0 2.38.194 3.437.543M9 9.6c0-1.036.242-2.03.67-2.957m1.64-3.09a25.226 25.226 0 011.64 0m-3.28 0a25.226 25.226 0 00-1.64 0" />
                            </svg></div>
                ...
                <table class="model-table">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>Rapid prototyping, bulk content creation.</td>
                        </tr>
                    </tbody>
                </table>
            </div>
