  ...
  <section id="faq" style="background-color: var(--card-color);">
            <div class="container">
                ...
                <div class="faq-container">
                    ...
                    <details class="faq-item"><summary>What can I create with it?</summary><div class="faq-content"><p>You can generate a wide variety of content, including videos with synchronized audio, silent videos, and videos with special effects. It's ideal for creating cinematic-quality content for commercials, film pre-visualization, social media, and educational purposes.</p></div></details>
                    <details class="faq-item"><summary>How do I use it?</summary><div class="faq-content"><p>It's a simple, three-step process: 1. Upload an image and write a prompt describing your scene and dialogue. 2. Choose the AI model that best fits your project's needs (e.g., quality, audio). 3. Click "Generate" and your video will be ready to preview and download in minutes.</p></div></details>
